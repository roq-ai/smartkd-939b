...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'team-member', 'support-agent', 'administrator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Manual', path: '/manuals', entity: 'manual', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    {
      name: 'Problem Fix',
      path: '/problem-fixes',
      entity: 'problem_fix',
