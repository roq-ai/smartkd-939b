...
import { getProblemFixById } from 'apiSdk/problem-fixes';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Problem Fix Detail View
          </Text>
          {hasAccess('problem_fix', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/problem-fixes/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('feedback', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/feedbacks/create?problem_fix_id=${data?.id}`}>
